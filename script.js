...
function handleFormSubmit(event) {
  ...
  //
  dest_card.innerHTML = `<img src=${photo} class="card-img-top" alt=${destinationName}|${destinationLocation}>
    <div class="dest_card-body">
      <h5 class="dest_card-title">${destinationName}</h5>
      <h6>${destinationLocation}</h6>
      <p class="dest_card-text">${destinationDescription}</p>
